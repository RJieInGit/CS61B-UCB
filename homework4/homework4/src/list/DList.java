...
public class DList {
  ...
  public void insertFront(Object item) {
    ...
    head.next=newnode;// Your solution here.
    size++;
  }
  ...
  public void insertBack(Object item) {
    ...
    head.prev=newnode;// Your solution here.
    size++;
  }
 ...
 return head.prev;
  ...
  public DListNode next(DListNode node) {
    if (node==null&&head.next!=head)
    	return head.next;
     else if(node!=null&&node.next!=head)
    return node.next;
     return null;// Your solution here.
  }
  ...
  public DListNode prev(DListNode node) {
    if(node==null&&head.prev!=head)
    	return head.prev;
    else if(node!=null&&node.prev!=head)
    	return node.prev;
    return null;// Your solution here.
  }
